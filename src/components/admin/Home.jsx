  ...
  "
      ...
      <div className=" mt-5">
        <div>
          ...
          <div className="mt-10 w-[85rem] ml-5 lg:ml-20 lg:flex lg:flex-row lg:justify-center lg:gap-12">
      ...
      <div className="w-85">
        <div className="flex justify-center ml-5 flex-col w-85 lg:flex-row mt-8 lg:w-[85rem] lg:ml-15">
        ...
        <div className=" flex justify-center ml-5 flex-col w-85 lg:flex-row lg:w-[85rem] lg:ml-15">
