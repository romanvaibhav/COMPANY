...
const SaasSection = () => {
  return (
    <div>
      <section className="w-[100vw] h-[100vh] flex flex-col  justify-between  mt-[30vh]   bg-white">
        <div className="w-[60vw] lg:w-1/2 mb-15 lg:mb-5">
          <h1 className="text-2xl lg:text-4xl font-bold mb-10">
            Custom SaaS App <br /> Development Company
          </h1>
          <p className="text-lg text-gray-700 w-[80vw] lg:w-[40vw] mb-10">
          ...
          <div className="ml-[-5px] flex ">
            <a
              href="#"
              className="text-base px-6 py-2 bg-blue-400 text-white rounded-lg hover:bg-white hover:text-blue-400 hidden lg:block"
            >
              Get Started
            </a>
            <a
              href="#"
              className="text-base px-3 py-2 text-blue-500  rounded-lg "
            >
        ...
        <div className="w-full lg:w-2/5  justify-center hidden lg:block">
          <img
      ...
      <section className="bg-black text-white  w-[100vw]">
        <div className="mb-12 ml-[10vw]">
          ...
          <p className="text-lg max-w-6xl mb-4">
        ...
        <div className="ml-[10vw]">
          <div className="w-full mb-10">
            <h3 className="text-2xl font-bold mb-2">Reduced Upfront Costs</h3>
          ...
          <div className="w-full mb-10">
            <h3 className="text-2xl font-bold mb-2">Effortless Scalability</h3>
            <p className="text-lg max-w-4xl">
          ...
          <div className="w-full mb-10">
            <h3 className="text-2xl font-bold mb-2">Better Accessibility</h3>
            <p className="text-lg max-w-4xl">
          ...
          <div className="w-full mb-10">
            <h3 className="text-2xl font-bold mb-2">Faster Time to Market</h3>
            <p className="text-lg max-w-4xl">
