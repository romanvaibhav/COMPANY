          ...
          <div className="mt-[7vh] ">
            ...
            >
              <span className="relative">
                ...
                {/* Underline */}
                <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-white transition-all duration-300 group-hover:bg-blue-600 group-hover:w-full"></span>
              </span>

              {/* Arrow */}
              <span className="inline-block transform translate-x-0 opacity-0 transition-all duration-300 group-hover:text-blue-600 group-hover:translate-x-1 group-hover:opacity-100">
                →
              </span>
            </button>
          </div>
