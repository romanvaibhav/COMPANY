    ...
    <div className="w-full h-[auto]">
      <div className="ml-[10vw] pb-[15vh] mt-[15vh]">
        ...
        <div className=" grid lg:grid-cols-2 gap-9 w-[76vw] mt-[6vh]">
          <div className="w-[80vw] lg:w-[37vw] h-[auto] border-1 border-gray-500 rounded-md bg-white">
          ...
          <div className="w-[80vw] lg:w-[37vw] h-[auto] lg:h-[26vh] border-1 border-gray-500 rounded-md bg-white">
            <div className="py-4 px-2 bg-gray-100 rounded-md font-semibold">
