export default function BlockchainLast() {
  return (
    <div>
      <section className="w-full bg-gradient-to-r animated-gradient text-white py-16 px-8 text-center shadow-lg">
        <div>
          ...
          <p className="text-lg mb-8 text-gray-100">
            Build secure, transparent, and decentralized applications with our
            expert Blockchain development and integration services.
          </p>
