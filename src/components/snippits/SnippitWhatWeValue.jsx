...
export default function SnippitWhatWeValue() {
  return (
    <div className=" w-[85vw] ml-[8vw] lg:w-[85rem] lg:ml-20 mt-25 pb-[9vh]">
      <div>
      ...
      <div className="mt-[8vh] ml-[5vw]">
        ...
        <div className="flex flex-row mt-10 lg:ml-5">
          <div>
            <img
          ...
          <div className="lg:ml-10 ml-10 lg:mt-20">
            <h1 className="font-semibold text-base lg:text-2xl">
              Integrity & Trust
            </h1>
            <p className="text-gray-600">
        ...
        <div className="flex flex-row mt-10 lg:ml-10">
          <div>
            <img
