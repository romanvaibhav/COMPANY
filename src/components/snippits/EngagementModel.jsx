      ...
      <div className="w-[100vw] mt-[5vh] bg-gradient-to-br from-white to-blue-100">
        <div className="flex justify-center items-center flex-col">
          ...
          <div className="lg:flex   lg:mt-[6vh]">
            <div className="lg:w-[28vw] lg:h-[44vh] lg:ml-[2vw] w-95 h-80 rounded-se-2xl shadow-2xl shadow-gray-400 hover:bg-gradient-to-br from-blue-100 to-purple-200">
              <div className="mt-[5vh]">
                <p className="lg:w-[24vw]  text-2xl font-semibold pl-[4vw]">
                ...
                <ul className="list-disc  marker:text-black marker:text-2xl pl-10 lg:pl-[4vw]">
            ...
            <div className="lg:w-[28vw] lg:h-[44vh] w-95 h-80 lg:ml-[2vw] rounded-se-2xl shadow-2xl shadow-gray-400 hover:bg-gradient-to-br from-blue-100 to-purple-200">
              <div className="mt-[5vh]">
                <p className="lg:w-[17vw] text-2xl font-semibold pl-[4vw]">
            ...
            <div className="lg:w-[28vw] lg:h-[44vh] w-95 h-80 lg:ml-[2vw] rounded-se-2xl  shadow-2xl shadow-gray-400 hover:bg-gradient-to-br from-blue-100 to-purple-200">
              <div className="mt-[5vh]">
                <p className="lg:w-[10vw] text-2xl font-semibold pl-[4vw]">
                  Staff Augmentation
                </p>
                <p className="pl-[2vw]">
