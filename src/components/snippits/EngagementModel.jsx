    ...
    <div>
      <div className="w-[100vw] mt-[5vh] bg-gradient-to-br from-white to-blue-100">
        <div className=" ml-[-1.5vw] flex justify-center items-center flex-col">
          ...
          <div className="lg:flex  lg:mt-[8vh]">
            <div className="lg:w-[26vw] lg:h-[44vh] lg:ml-[4vw] w-86 h-60 rounded-md shadow-2xl shadow-gray-400 hover:bg-gradient-to-br from-blue-100 to-purple-200">
              <div className="mt-[5vh]">
                <p className="lg:w-[24vw] pt-5 text-xl lg:text-2xl font-semibold pl-[4vw]">
                  Outsourced Product Development
                </p>
                <p className="lg:pl-[2vw] font-semibold text-gray-600   pl-4 mt-3">
                  End-to-end AI product development from ideation to deployment
                  and maintenance.
                </p>
                <ul className="list-disc mt-3  marker:text-gray-600 marker:text-2xl pl-10 lg:pl-[4vw]">
            ...
            <div className="lg:w-[26vw] lg:h-[44vh] w-86 h-60 lg:ml-[2vw] rounded-md shadow-2xl shadow-gray-400 hover:bg-gradient-to-br from-blue-100 to-purple-200">
              <div className="mt-[5vh]">
